...
from datetime import datetime                                             # This is for importing dateandtime to get the present Date and Time of the system
...
present_date_time = datetime.now().strftime ("%m-%d-%y %H:%M:%S")            # To get the present Date and time from dateandtime
